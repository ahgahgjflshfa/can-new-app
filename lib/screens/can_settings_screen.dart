...
class CanSettingsScreen extends StatelessWidget {
  const CanSettingsScreen({
    required this.api,
    required this.user,
...
class AdvancedCanSettingsScreen extends StatelessWidget {
  const AdvancedCanSettingsScreen({
    required this.api,
    required this.user,
    required this.deviceId,
    required this.pushService,
  ...
  Future<void> _onShareDebug(
    ...
    buffer.writeln('=== Q 潔淨立馬清 Debug Report ===');
